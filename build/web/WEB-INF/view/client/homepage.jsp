...
<html lang="en">
    ...
    <head>
        ...
        <title>Trang chủ - Smartphone shop</title>
        ...
        <link
            href="${pageContext.request.contextPath}/resources/client/lib/lightbox/css/lightbox.min.css"
            rel="stylesheet">
        <link rel="stylesheet"
    ...
    <body>
                                                ...
                                                <div class="rounded position-relative fruite-item">
                                                    ...
                                                    <div
                                                        ...
                                                        <h4 style="font-size: 15px;">
                                                            <a
                                                                href="${pageContext.request.contextPath}/client?action=showProductInfor&id=${product.id}">${product.name}</a>
                                                        </h4>
        ...
        <script
        src="${pageContext.request.contextPath}/resources/client/lib/easing/easing.min.js"></script>
        <script
        src="${pageContext.request.contextPath}/resources/client/lib/waypoints/waypoints.min.js"></script>
        <script
        src="${pageContext.request.contextPath}/resources/client/lib/lightbox/js/lightbox.min.js"></script>
        <script
        src="${pageContext.request.contextPath}/resources/client/lib/owlcarousel/owl.carousel.min.js"></script>
