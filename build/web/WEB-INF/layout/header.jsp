        ...
        <nav class="navbar navbar-light bg-white navbar-expand-xl">
            ...
            <div class="collapse navbar-collapse bg-white justify-content-between mx-5" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a href="${pageContext.request.contextPath}/client?action=allProductsPage" class="nav-item nav-link">Sản phẩm</a>
                </div>
                <div class="d-flex m-3 me-0">
                    <c:if test="${not empty sessionScope.username}">
                        <a href="${pageContext.request.contextPath}/client?action=showCart" class="position-relative me-4 my-auto">
                            <i class="fa fa-shopping-bag fa-2x"></i>
                            <span id="cart-count"
                                class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1"
                                style="top: -5px; left: 15px; height: 20px; min-width: 20px;">${sessionScope.cart.getCartDetails() != null ? sessionScope.cart.getCartDetails().size() : 0}</span>
                        </a>
