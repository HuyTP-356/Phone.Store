                            ...
                            <c:forEach var="order" items="${orders}">
                                ...
                                <c:forEach var="orderItem" items="${order.getOrderItems()}">
                                    <tr>
                                        ...
                                        <td>
                                            <p class="mb-0 mt-4">
                                                <a href="${pageContext.request.contextPath}/client?action=showProductInfor&id=${orderItem.product.id}"
                                                   target="_blank">
                                        ...
                                        <td>
                                            <p class="mb-0 mt-4" data-cart-detail-id="${orderItem.product.id}">
                                                <fmt:formatNumber type="number"
                                                                  value="${orderItem.product.price * orderItem.quantity}" /> đ
                                            </p>
                                        </td>
                                        <td></td>
