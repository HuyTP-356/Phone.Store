...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title> Thanh toán - Smartphone shop</title>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <c:if test="${not empty cart.getCartDetails()}">
                    <form action="${pageContext.request.contextPath}/client?action=handleCheckOut" method="post">
                                ...
                                <div class="p-4 ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <a href="${pageContext.request.contextPath}/client?action=showCart">Quay
                                                lại giỏ hàng</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="bg-light rounded">
                                    ...
                                    <div
                                        ...
                                        <p class="mb-0 pe-4" data-cart-total-price="${sessionScope.totalPrice}">
                                            <fmt:formatNumber type="number" value="${sessionScope.totalPrice}" /> đ
                                        </p>
                                    </div>

                                    <button
                                        class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4 submitCheckOut" data-id="${product.id}" data-context="${pageContext.request.contextPath}">
                                        Xác nhận thanh toán
                                    </button>
