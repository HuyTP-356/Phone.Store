    ...
    <%@ page import="model.User" %>
        <%@ page import="java.util.List" %>
            <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                ...
                <% // Kiểm tra trạng thái đăng nhập; nếu chưa đăng nhập, chuyển hướng về trang đăng nhập if
                    (session.getAttribute("user")==null) { response.sendRedirect("login.jsp"); return; // Dừng xử lý JSP
                    nếu chưa đăng nhập } %>
                    ...
                    <body>
                        ...
                        <div class="container mt-4">
                            ...
                            <!-- Lấy đối tượng User từ session và hiển thị thông tin -->
